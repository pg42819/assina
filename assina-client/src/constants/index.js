...
export const ASSINA_RSSP_BASE_URL = process.env.REACT_APP_API_BASE_URL || 'http://localhost:8080';
export const ASSINA_CLIENT_BASE_URL = process.env.REACT_APP_API_BASE_URL || 'http://localhost:3000';
